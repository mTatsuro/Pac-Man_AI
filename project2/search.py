...
def depthFirstSearch(problem):
    ...
    """
    "*** YOUR CODE HERE ***"
    newStates = util.Stack()
    visitedStates = []

    # get the first
    newStates.push((problem.getStartState(), []))
    ...
    while not newStates.isEmpty():
        ...
        if not states in visitedStates:
            ...
            for successor in problem.getSuccessors(states):
                newStates.push((successor[0], actions + [successor[1]]))
    util.raiseNotDefined()
...
def uniformCostSearch(problem):
    ...
    while not newStates.isEmpty():
        ...
        if not states in visitedStates:
            ...
            for successor in problem.getSuccessors(states):
                if not successor[0] in visitedStates:
                    newStates.push((successor[0], actions + [successor[1]]), problem.getCostOfActions(actions + [successor[1]]))
    util.raiseNotDefined()
